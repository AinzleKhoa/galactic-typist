...
public class CongratulationLabel extends JLabel {

    private String playerName;
    private Font customFont;

    // Constructor to set up the label properties
    public CongratulationLabel(String playerName) {
        this.playerName = playerName;
        setupTextLabel();
        loadCustomFont();
        setFont(customFont != null ? customFont : new Font("Roboto", Font.BOLD, 25));
    }
    ...
    private void loadCustomFont() {
        try {
            ...
            MainManager.logError("Error with loading the font... CongratulationLabel", e);
            customFont = null;
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        String message = "Congratulation, Astroer '" + playerName + "' for completing the game!";
    ...
    private void drawTextWithShadow(Graphics g, String text, int x, int y) {
        if (customFont == null) {
            customFont = new Font("Roboto", Font.BOLD, 25);  // Fallback font
        }
