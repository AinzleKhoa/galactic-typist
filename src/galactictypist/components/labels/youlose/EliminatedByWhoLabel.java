...
public class EliminatedByWhoLabel extends JLabel {

    private int eliminatedByWho = 0;
    private Font customFont;

    // Constructor to set up the label properties
    public EliminatedByWhoLabel(int eliminatedByWho) {
        setupTextLabel();
    ...
    private void loadCustomFont() {
        try {
            ...
            MainManager.logError("Error with loading the font... EliminatedByWhoLabel", e);
            customFont = null;
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        int initialStartX = 0;  // Adjust based on your layout
        int initialStartY = 80;   // Adjust based on your layout

        // Determine the text based on the eliminatedByWho value
        String message;
        switch (eliminatedByWho) {
            case 1:
                message = "You have been eliminated by UFO";
                break;
            case 2:
                message = "You have been eliminated by Night Stalker";
                break;
            case 3:
                message = "You have been eliminated by Astral Raider";
                break;
            default:
