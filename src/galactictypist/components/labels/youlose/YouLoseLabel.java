...
public class YouLoseLabel extends JLabel {

    private Font customFont;
    private int level = 1;

    // Constructor to set up the label properties
    public YouLoseLabel(int level) {
        this.level = level;
        setupTextLabel();
    ...
    private void loadCustomFont() {
        try {
            ...
            MainManager.logError("Error with loading the font... YouLoseLabel", e);
            customFont = null;
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        String message = (level != 0) ? "You Lose!" : "Game Over!";
        int initialStartX = 90;  // Adjust based on your layout
