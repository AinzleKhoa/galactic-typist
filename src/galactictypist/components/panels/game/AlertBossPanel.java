 ...
 * @author Ainzle
 */
public class AlertBossPanel extends JPanel {
    ...
    public AlertBossPanel(String ImagePath) {
    ...
    public void showImage(int widthImage, int heightImage) {
        ...
        // Calculate center positions based on the current frame dimensions and image size
