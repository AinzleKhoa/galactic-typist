 ...
 * @author Ainzle
 */
public class BossDefeatedFinalePanel4 extends JPanel {
    ...
    public BossDefeatedFinalePanel4(String ImagePath) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isVisible()) {
            g.drawImage(theImage, centerX, centerY-80, widthImage, heightImage, this);
        }
    }
}
